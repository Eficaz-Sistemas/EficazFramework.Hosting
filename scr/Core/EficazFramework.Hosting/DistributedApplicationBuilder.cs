...
using EficazFramework.Hosting.Dashboard;
using EficazFramework.Hosting.Dcp;
using EficazFramework.Hosting.Lifecycle;
using EficazFramework.Hosting.Publishing;
...
{
    private const string HostingDiagnosticListenerName = "EficazFramework.Hosting";
